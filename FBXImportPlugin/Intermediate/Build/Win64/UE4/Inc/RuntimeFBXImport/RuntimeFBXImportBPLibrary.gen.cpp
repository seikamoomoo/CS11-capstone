...
// Cross Module References
	RUNTIMEFBXIMPORT_API UEnum* Z_Construct_UEnum_RuntimeFBXImport_EFBXLightType();
	...
	RUNTIMEFBXIMPORT_API UScriptStruct* Z_Construct_UScriptStruct_FFBXCameraData();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FTransform();
	RUNTIMEFBXIMPORT_API UScriptStruct* Z_Construct_UScriptStruct_FFBXLightData();
	...
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_CheckHitAtCameraLocation();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	ENGINE_API UClass* Z_Construct_UClass_UCameraComponent_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_CheckHitAtMouseCursor();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetALLFBXSavedFiles();
	RUNTIMEFBXIMPORT_API UClass* Z_Construct_UClass_UFBXSaveGame_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetFiles();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetOpenFileDialogue();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_LoadTexturefromPath();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_URuntimeFBXImportBPLibrary_SaveFBXGame();
	RUNTIMEFBXIMPORT_API UClass* Z_Construct_UClass_AFBXMeshActor_NoRegister();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject_NoRegister();
// End Cross Module References
	static UEnum* EFBXLightType_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_RuntimeFBXImport_EFBXLightType, Z_Construct_UPackage__Script_RuntimeFBXImport(), TEXT("EFBXLightType"));
		}
		return Singleton;
	}
	template<> RUNTIMEFBXIMPORT_API UEnum* StaticEnum<EFBXLightType>()
	{
		return EFBXLightType_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFBXLightType(EFBXLightType_StaticEnum, TEXT("/Script/RuntimeFBXImport"), TEXT("EFBXLightType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_RuntimeFBXImport_EFBXLightType_Hash() { return 1703329856U; }
	UEnum* Z_Construct_UEnum_RuntimeFBXImport_EFBXLightType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_RuntimeFBXImport();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EFBXLightType"), 0, Get_Z_Construct_UEnum_RuntimeFBXImport_EFBXLightType_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EFBXLightType::Point", (int64)EFBXLightType::Point },
				{ "EFBXLightType::Directional", (int64)EFBXLightType::Directional },
				{ "EFBXLightType::Spot", (int64)EFBXLightType::Spot },
				{ "EFBXLightType::Area", (int64)EFBXLightType::Area },
				{ "EFBXLightType::Volume", (int64)EFBXLightType::Volume },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "Area.DisplayName", "Area" },
				{ "Area.Name", "EFBXLightType::Area" },
				{ "BlueprintType", "true" },
				{ "Directional.DisplayName", "Directional" },
				{ "Directional.Name", "EFBXLightType::Directional" },
				{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
				{ "Point.DisplayName", "Point" },
				{ "Point.Name", "EFBXLightType::Point" },
				{ "Spot.DisplayName", "Spot" },
				{ "Spot.Name", "EFBXLightType::Spot" },
				{ "Volume.DisplayName", "Volume" },
				{ "Volume.Name", "EFBXLightType::Volume" },
			};
#endif
	...
	uint32 Get_Z_Construct_UEnum_RuntimeFBXImport_EFBXCollisionType_Hash() { return 2308904233U; }
	UEnum* Z_Construct_UEnum_RuntimeFBXImport_EFBXCollisionType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EFBXCollisionType::MeshCollision", (int64)EFBXCollisionType::MeshCollision },
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "MeshCollision.Name", "EFBXCollisionType::MeshCollision" },
...
static struct FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXNodeStructure
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FFBXNodeStructure_Hash() { return 682553270U; }
...
static struct FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXSectionStructure
{
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FFBXSectionStructure_Statics::NewProp_TextureParamInfo = { "TextureParamInfo", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXSectionStructure, TextureParamInfo), METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXSectionStructure_Statics::NewProp_TextureParamInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXSectionStructure_Statics::NewProp_TextureParamInfo_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FFBXSectionStructure_Statics::NewProp_ScalarParamInfo = { "ScalarParamInfo", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXSectionStructure, ScalarParamInfo), METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXSectionStructure_Statics::NewProp_ScalarParamInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXSectionStructure_Statics::NewProp_ScalarParamInfo_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FFBXSectionStructure_Hash() { return 3793141796U; }
class UScriptStruct* FFBXCameraData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern RUNTIMEFBXIMPORT_API uint32 Get_Z_Construct_UScriptStruct_FFBXCameraData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FFBXCameraData, Z_Construct_UPackage__Script_RuntimeFBXImport(), TEXT("FBXCameraData"), sizeof(FFBXCameraData), Get_Z_Construct_UScriptStruct_FFBXCameraData_Hash());
	}
	return Singleton;
}
template<> RUNTIMEFBXIMPORT_API UScriptStruct* StaticStruct<FFBXCameraData>()
{
	return FFBXCameraData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FFBXCameraData(FFBXCameraData::StaticStruct, TEXT("/Script/RuntimeFBXImport"), TEXT("FBXCameraData"), false, nullptr, nullptr);
static struct FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXCameraData
{
	FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXCameraData()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("FBXCameraData")),new UScriptStruct::TCppStructOps<FFBXCameraData>);
	}
} ScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXCameraData;
	struct Z_Construct_UScriptStruct_FFBXCameraData_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXCameraData_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/**\n * This structure represent Camera data.\n */" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
		{ "ToolTip", "This structure represent Camera data." },
	};
#endif
	void* Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FFBXCameraData>();
	}
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_Transform_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXCameraData, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_NodeName_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_NodeName = { "NodeName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXCameraData, NodeName), METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_NodeName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_NodeName_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FFBXCameraData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_Transform,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXCameraData_Statics::NewProp_NodeName,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFBXCameraData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_RuntimeFBXImport,
		nullptr,
		&NewStructOps,
		"FBXCameraData",
		sizeof(FFBXCameraData),
		alignof(FFBXCameraData),
		Z_Construct_UScriptStruct_FFBXCameraData_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXCameraData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXCameraData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXCameraData_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FFBXCameraData()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FFBXCameraData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_RuntimeFBXImport();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("FBXCameraData"), sizeof(FFBXCameraData), Get_Z_Construct_UScriptStruct_FFBXCameraData_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FFBXCameraData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FFBXCameraData_Hash() { return 3757917340U; }
class UScriptStruct* FFBXLightData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern RUNTIMEFBXIMPORT_API uint32 Get_Z_Construct_UScriptStruct_FFBXLightData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FFBXLightData, Z_Construct_UPackage__Script_RuntimeFBXImport(), TEXT("FBXLightData"), sizeof(FFBXLightData), Get_Z_Construct_UScriptStruct_FFBXLightData_Hash());
	}
	return Singleton;
}
template<> RUNTIMEFBXIMPORT_API UScriptStruct* StaticStruct<FFBXLightData>()
{
	return FFBXLightData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FFBXLightData(FFBXLightData::StaticStruct, TEXT("/Script/RuntimeFBXImport"), TEXT("FBXLightData"), false, nullptr, nullptr);
static struct FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXLightData
{
	FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXLightData()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("FBXLightData")),new UScriptStruct::TCppStructOps<FFBXLightData>);
	}
} ScriptStruct_RuntimeFBXImport_StaticRegisterNativesFFBXLightData;
	struct Z_Construct_UScriptStruct_FFBXLightData_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXLightData_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/**\n * This structure represent Light data.\n */" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
		{ "ToolTip", "This structure represent Light data." },
	};
#endif
	void* Z_Construct_UScriptStruct_FFBXLightData_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FFBXLightData>();
	}
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Color_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXLightData, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Color_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Intensity_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Intensity = { "Intensity", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXLightData, Intensity), METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Intensity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Intensity_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Transform_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXLightData, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType = { "LightType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXLightData, LightType), Z_Construct_UEnum_RuntimeFBXImport_EFBXLightType, METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_NodeName_MetaData[] = {
		{ "Category", "Defaults" },
		{ "ModuleRelativePath", "Public/RuntimeFBXImportBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_NodeName = { "NodeName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBXLightData, NodeName), METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_NodeName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_NodeName_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FFBXLightData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Color,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Intensity,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_Transform,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_LightType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFBXLightData_Statics::NewProp_NodeName,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFBXLightData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_RuntimeFBXImport,
		nullptr,
		&NewStructOps,
		"FBXLightData",
		sizeof(FFBXLightData),
		alignof(FFBXLightData),
		Z_Construct_UScriptStruct_FFBXLightData_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FFBXLightData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBXLightData_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FFBXLightData()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FFBXLightData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_RuntimeFBXImport();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("FBXLightData"), sizeof(FFBXLightData), Get_Z_Construct_UScriptStruct_FFBXLightData_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FFBXLightData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FFBXLightData_Hash() { return 4048495793U; }
...
static struct FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFProceduralMeshSection
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Tangents = { "Tangents", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralMeshSection, Tangents), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Tangents_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Tangents_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_UVs = { "UVs", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralMeshSection, UVs), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_UVs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_UVs_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Normals = { "Normals", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralMeshSection, Normals), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Normals_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Normals_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Triangles = { "Triangles", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralMeshSection, Triangles), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Triangles_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Triangles_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Vertices = { "Vertices", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralMeshSection, Vertices), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Vertices_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralMeshSection_Statics::NewProp_Vertices_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FProceduralMeshSection_Hash() { return 1885930043U; }
...
static struct FScriptStruct_RuntimeFBXImport_StaticRegisterNativesFMaterialDynamicStructure
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FMaterialDynamicStructure_Hash() { return 1424748085U; }
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetFiles_Statics::NewProp_FilenamesOut = { "FilenamesOut", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeFBXImportBPLibrary_eventGetFiles_Parms, FilenamesOut), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetOpenFileDialogue_Statics::NewProp_FileNames = { "FileNames", nullptr, (EPropertyFlags)0x0010000000000180, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RuntimeFBXImportBPLibrary_eventGetOpenFileDialogue_Parms, FileNames), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URuntimeFBXImportBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_CheckHitAtCameraLocation, "CheckHitAtCameraLocation" }, // 4200004158
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_CheckHitAtMouseCursor, "CheckHitAtMouseCursor" }, // 4219711765
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetALLFBXSavedFiles, "GetALLFBXSavedFiles" }, // 569962802
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetFiles, "GetFiles" }, // 508026348
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_GetOpenFileDialogue, "GetOpenFileDialogue" }, // 3303956166
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_LoadTexturefromPath, "LoadTexturefromPath" }, // 2089473961
		{ &Z_Construct_UFunction_URuntimeFBXImportBPLibrary_SaveFBXGame, "SaveFBXGame" }, // 819872596
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(URuntimeFBXImportBPLibrary, 3269497517);
