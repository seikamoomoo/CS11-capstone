...
// Cross Module References
	...
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_DeSelectAllComponents();
	RUNTIMEFBXIMPORT_API UClass* Z_Construct_UClass_AFBXMeshActor_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_FinishImport();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_GetFBXSection();
	RUNTIMEFBXIMPORT_API UScriptStruct* Z_Construct_UScriptStruct_FFBXSectionStructure();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_GetScalarParamValue();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_GetTextureParamValue();
	ENGINE_API UClass* Z_Construct_UClass_UTexture_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_GetVectorParamValue();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FLinearColor();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_HideSelection();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_ImportFBXFile();
	RUNTIMEFBXIMPORT_API UEnum* Z_Construct_UEnum_RuntimeFBXImport_EFBXCollisionType();
	ENGINE_API UClass* Z_Construct_UClass_UMaterialInterface_NoRegister();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_IsolateSelection();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_LoadFBXFromSaveGameObject();
	RUNTIMEFBXIMPORT_API UClass* Z_Construct_UClass_UFBXSaveGame_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnFBXActorSelected();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnFBXNodeProgressChanged();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnFBXSectionImported();
	RUNTIMEFBXIMPORT_API UScriptStruct* Z_Construct_UScriptStruct_FProceduralMeshSection();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnFBXSectionProgressChanged();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnImportCompleted();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnImportLights();
	RUNTIMEFBXIMPORT_API UScriptStruct* Z_Construct_UScriptStruct_FFBXLightData();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_OnNewFBXImportStarted();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_SelectMeshComponent();
	ENGINE_API UClass* Z_Construct_UClass_UPrimitiveComponent_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_SelectNode();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_SelectNodeSection();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_UnHideAll();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_UpdateScalarParam();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_UpdateSectionMaterial();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_UpdateTextureParam();
	ENGINE_API UClass* Z_Construct_UClass_UTexture2D_NoRegister();
	RUNTIMEFBXIMPORT_API UFunction* Z_Construct_UFunction_AFBXImportManager_UpdateVectorParam();
...
// End Cross Module References
	...
	static FName NAME_AFBXImportManager_OnImportLights = FName(TEXT("OnImportLights"));
	void AFBXImportManager::OnImportLights(TArray<FFBXLightData> const& LightData)
	{
		FBXImportManager_eventOnImportLights_Parms Parms;
		Parms.LightData=LightData;
		ProcessEvent(FindFunctionChecked(NAME_AFBXImportManager_OnImportLights),&Parms);
	}
	...
	struct Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics
	{
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LightData_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_LightData;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_LightData_Inner;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData = { "LightData", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBXImportManager_eventOnImportLights_Parms, LightData), METADATA_PARAMS(Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData_Inner = { "LightData", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FFBXLightData, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::NewProp_LightData_Inner,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::Function_MetaDataParams[] = {
		{ "Category", "FBXImport" },
		{ "ModuleRelativePath", "Public/FBXImportManager.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFBXImportManager, nullptr, "OnImportLights", nullptr, nullptr, sizeof(FBXImportManager_eventOnImportLights_Parms), Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08420800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFBXImportManager_OnImportLights()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFBXImportManager_OnImportLights_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AFBXImportManager_SelectNode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010008000000580, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBXImportManager_eventSelectNode_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFBXImportManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFBXImportManager_DeSelectAllComponents, "DeSelectAllComponents" }, // 3208201922
		{ &Z_Construct_UFunction_AFBXImportManager_FinishImport, "FinishImport" }, // 2605664968
		{ &Z_Construct_UFunction_AFBXImportManager_GetFBXSection, "GetFBXSection" }, // 245620935
		{ &Z_Construct_UFunction_AFBXImportManager_GetScalarParamValue, "GetScalarParamValue" }, // 3008286648
		{ &Z_Construct_UFunction_AFBXImportManager_GetTextureParamValue, "GetTextureParamValue" }, // 2166120016
		{ &Z_Construct_UFunction_AFBXImportManager_GetVectorParamValue, "GetVectorParamValue" }, // 3766812453
		{ &Z_Construct_UFunction_AFBXImportManager_HideSelection, "HideSelection" }, // 2636146580
		{ &Z_Construct_UFunction_AFBXImportManager_ImportFBXFile, "ImportFBXFile" }, // 1343025925
		...
		{ &Z_Construct_UFunction_AFBXImportManager_OnFBXNodeProgressChanged, "OnFBXNodeProgressChanged" }, // 1693877609
		{ &Z_Construct_UFunction_AFBXImportManager_OnFBXSectionImported, "OnFBXSectionImported" }, // 1858184793
		{ &Z_Construct_UFunction_AFBXImportManager_OnFBXSectionProgressChanged, "OnFBXSectionProgressChanged" }, // 519886997
		{ &Z_Construct_UFunction_AFBXImportManager_OnImportCompleted, "OnImportCompleted" }, // 1088945704
		{ &Z_Construct_UFunction_AFBXImportManager_OnImportLights, "OnImportLights" }, // 566083312
		{ &Z_Construct_UFunction_AFBXImportManager_OnNewFBXImportStarted, "OnNewFBXImportStarted" }, // 38476579
		{ &Z_Construct_UFunction_AFBXImportManager_SelectMeshComponent, "SelectMeshComponent" }, // 2547736330
		{ &Z_Construct_UFunction_AFBXImportManager_SelectNode, "SelectNode" }, // 2983545993
		{ &Z_Construct_UFunction_AFBXImportManager_SelectNodeSection, "SelectNodeSection" }, // 808947769
		{ &Z_Construct_UFunction_AFBXImportManager_UnHideAll, "UnHideAll" }, // 1958643844
		{ &Z_Construct_UFunction_AFBXImportManager_UpdateScalarParam, "UpdateScalarParam" }, // 803340366
		{ &Z_Construct_UFunction_AFBXImportManager_UpdateSectionMaterial, "UpdateSectionMaterial" }, // 2197063455
		{ &Z_Construct_UFunction_AFBXImportManager_UpdateTextureParam, "UpdateTextureParam" }, // 355853509
		{ &Z_Construct_UFunction_AFBXImportManager_UpdateVectorParam, "UpdateVectorParam" }, // 2855815540
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFBXImportManager, 3782335209);
